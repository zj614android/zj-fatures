...
public class ItemMarginDemo extends Activity {
    ...
    private void initBannerView(MZBannerView mMZBanner) {
        mMZBanner.setBannerPageClickListener(new MZBannerView.BannerPageClickListener() {
            ...
            public void onPageClick(View view, int position) {
                Toast.makeText(ItemMarginDemo.this,"click page:"+position,Toast.LENGTH_LONG).show();
            }
        });
    ...
    public static class BannerViewHolder implements MZViewHolder<Integer> {
        ...
        public View createView(Context context) {
            // 返回页面布局文件
            View view = LayoutInflater.from(context).inflate(R.layout.banner_debug_item,null);
